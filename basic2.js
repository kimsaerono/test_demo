...
(function() {
        ...
        var bind_change_event = function(customerStyle) {
            ...
            firstLevelSelector.unbind("change").change(function(){
                ...
                if(firstLevelSelector.val()) {
                    businessCategorySecondLevelSelector.getSecondCategory(firstLevelSelector.find("option:selected").attr('value'));
                } else {
                    // 一级分类未选择时，清空二级分类选择器
    ...
    var businessCategorySecondLevelSelector = (function() {
        ...
        var setSecondCategoryOption = function(categoryMap) {
            var text = '';
        ...
        // 获取二级分类信息
        var getSecondCategory = function(firstCategoryCode, selectedSecondCategoryCode) {
            ...
            Common.ajax(contextPath + '/app/yqt/common/queryCategory', 'GET', {code: firstCategoryCode, notPublicWelfare: isFilter}, function (response) {
